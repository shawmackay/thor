...
public class ThorConfigurationClientChecker implements net.jini.discovery.DiscoveryListener {
    private net.jini.discovery.LookupDiscoveryManager ldm;
    private net.jini.lease.LeaseRenewalManager lrm;
    private final String[] GROUPS = {"production"};
    private final Configuration config;

    /** Creates new ThorClient 
     * @throws ConfigurationException*/
    public ThorConfigurationClientChecker(String[] args) throws ConfigurationException {
    ...
    public void discovered(net.jini.discovery.DiscoveryEvent discoveryEvent) {
        try {
            ...
            net.jini.core.entry.Entry[] attrs = {new net.jini.lookup.entry.Name("thortest")};
            ...
            if (thor != null) {
                ...
                Branch thorConfigurationBranch = sessionRoot.getBranch("general/thorconfig");                
                System.out.println("ThorConfigurationBranch Data: \n" + thorConfigurationBranch.getData() +"\nEnd ThorConfigurationBranch Data");
                //Add the change listeners to Thor
                Remote proxy =exp.export(handleAllMods); 
               EventRegistration evReg = thorConfigurationBranch.trackChanges(2000L, (ChangeEventListener) proxy, "");
               ...
               System.out.println("Renewing the lease");
                lrm.renewFor(evReg.getLease(), 180000L, null);
                System.out.println("The LEase is set for renewal");
...
//                System.out.println("Object add  (redirected)");
    ...
    public static void main(String[] args) {
        ...
        try {
			ThorConfigurationClientChecker client = new ThorConfigurationClientChecker(args);
